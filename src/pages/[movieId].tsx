...
export const getServerSideProps: GetServerSideProps<{
  ...
  const responseData =
    q === null ? await getMovieList(page) : await getSearchMovieList(q!, page);
  const detailResponseData =
    movieId && Number(movieId) ? await getMovie(Number(movieId)) : null;
...
const Page: React.FC<typeMovieResponseMiddle> = ({
  data,
  page,
  perPage,
  searchPhrase,
