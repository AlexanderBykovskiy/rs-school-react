...
const Details: React.FC<typeDetailsProps> = ({data: detailsData, page, perPage, q}) => {
  ...
  return (
    <>{detailsData && <div className={classes.wrapper} data-testid="details">
        <Link href={"/" + paramsCreator(String(page), String(perPage), q)} className={classes.closeButton}>
          <svg
